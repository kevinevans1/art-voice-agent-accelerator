"""
Tool Registry for Customer Support Agent - Following ARTAgent Pattern

This module provides the tool registry that maps function names to their implementations.
Azure AI Foundry automatically generates schemas from function signatures and docstrings,
so no manual schema definitions are needed.
"""
