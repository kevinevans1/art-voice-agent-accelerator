...
class ConversationManifest:
    ...
    def _get_cache_filename(self, text: str, voice: str = "en-US-JennyMultilingualNeural") -> str:
        ...
        try:
            ...
            for flow_name, flow_data in data.get('flows', {}).items():
                turns = [
                    ...
                    for turn_data in flow_data['turns']
                ]
    ...
    def _save_manifest(self):
        ...
        data = {
            ...
            'flows': {
                name: asdict(flow) for name, flow in self.flows.items()
            }
        }
...
def initialize_default_flows(cache_dir: str = "tests/load/audio_cache") -> ConversationManifest:
