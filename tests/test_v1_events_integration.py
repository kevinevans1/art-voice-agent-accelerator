...
from apps.rtagent.backend.api.v1.events.processor import CallEventProcessor, reset_call_event_processor
from apps.rtagent.backend.api.v1.events.handlers import CallEventHandlers
from apps.rtagent.backend.api.v1.events.types import CallEventContext, ACSEventTypes, V1EventTypes
...
class TestV1EventsIntegration:
    ...
    async def test_default_handlers_registration(self):
        ...
        from apps.rtagent.backend.api.v1.events.processor import get_call_event_processor
    ...
    async def test_call_connected_handler(self, sample_call_event_context):
        ...
        with patch('apps.rtagent.backend.api.v1.events.handlers.broadcast_message') as mock_broadcast:
    ...
    async def test_process_call_events_delegation(self, mock_redis_mgr):
        ...
        with patch('apps.rtagent.backend.api.v1.events.processor.get_call_event_processor') as mock_get_processor:
