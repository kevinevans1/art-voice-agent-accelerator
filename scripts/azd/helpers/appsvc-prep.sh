...
main() {
    ...
    echo "   Backend:  rtagents/$AGENT/backend/ (with workspace structure)"
    echo ""
    echo "💡 Next steps:"
    echo "   1. Enable services in azure.yaml"
    echo "   2. Run 'azd deploy' to deploy both services"
    echo "   3. Or run 'azd up' for full provision + deploy"
    echo "========================================================================="
}
