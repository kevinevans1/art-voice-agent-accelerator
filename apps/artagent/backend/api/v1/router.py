...
from .endpoints import agent_builder, browser, calls, channels, health, media, metrics, scenario_builder, scenarios, sessions
...
v1_router.include_router(channels.router, prefix="/channels")
