...
class Participant(TimestampedModel):
    ...
    can_speak: bool = Field(
        default=True,
        description="Whether participant can speak (unmuted)"
    )
    
    can_listen: bool = Field(
        default=True,
        description="Whether participant can hear audio"
    )

    # Session information
    session_id: Optional[str] = Field(
        default=None,
        description="Session identifier for this participant"
    )
    ...
    audio_quality_score: Optional[float] = Field(
        default=None,
        description="Audio quality score (0.0 to 1.0)"
    )
    
    network_quality_score: Optional[float] = Field(
        default=None,
        description="Network quality score (0.0 to 1.0)"
    )
    
    # Interaction tracking
    total_speak_time_seconds: int = Field(
        default=0,
        description="Total time participant spoke in seconds"
    )
    
    total_mute_time_seconds: int = Field(
        default=0,
        description="Total time participant was muted in seconds"
    )
    
    interaction_count: int = Field(
        default=0,
        description="Number of interactions (speak turns)"
    )
    
    # Timestamps
    invited_at: Optional[datetime] = Field(
        default=None,
        description="When the participant was invited"
    )
    ...
    preferences: Dict = Field(
        ...
        description="Participant preferences and settings"
    )
    ...
    device_info: Optional[Dict] = Field(
        default=None,
        description="Information about participant's device"
    )
    
    browser_info: Optional[Dict] = Field(
        default=None,
        description="Browser information if web-based"
    )
