...
class Call(TimestampedModel):
    ...
    connected_at: Optional[datetime] = Field(
        default=None,
        description="When the call was connected"
    )
    ...
    agent_config: Dict = Field(
        ...
        description="Agent configuration used for this call"
    )
...
class CallParticipant(TimestampedModel):
    ...
    left_at: Optional[datetime] = Field(
        default=None,
        description="When the participant left the call"
    )
    
    # Media capabilities
    audio_enabled: bool = Field(
        default=True,
        description="Whether audio is enabled for this participant"
    )
    
    video_enabled: bool = Field(
        default=False,
        description="Whether video is enabled for this participant"
    )
