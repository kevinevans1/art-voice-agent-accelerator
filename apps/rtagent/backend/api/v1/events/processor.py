...
class CallEventProcessor:
    ...
    async def process_events(self, events: List[CloudEvent], request_state: Any) -> Dict[str, Any]:
        ...
        with tracer.start_as_current_span(
            ...
            logger.info(f"✅ Processed {processed_count}/{len(events)} events successfully")
    ...
    async def _execute_handlers(self, handlers: List[CallEventHandler], context: CallEventContext) -> None:
